# Olá 👋, sou Thiago Matos da Silva

🚀 **Engenheiro de Produção | Engenheiro de Dados | Desenvolvimento de Software**  
🇧🇷 Brasil

Sou ** Desenvolvedor de sistemas e Engenheiro de produção** com foco em construir **sistemas escaláveis**, **soluções orientadas a dados** e **otimização de performance**.  
Sou apaixonado por **desenvolvimento de software**, **arquitetura limpa** e **estratégias voltadas para os negócios**.
...
-   🏗️ **Engenharia de Dados** & **Sistemas de grande escala**
-   ⚡ **Otimização de performance** & **Soluções orientadas a dados**
-   🧩 **Arquitetura limpa** & **Design de sistemas**
-   🔐 **APIs seguras** & **Autenticação**
-   🤖 **Automatização** & **Integrações**
-   📊 **Painéis de controle** & **Análise de dados**
...
## 🔧 Engenharia de Produção e Dados
...
> _"Código de verdade não impressiona no commit.  
> Ele prova seu valor com o tempo."_
